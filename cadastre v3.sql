...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 18 jan. 2025 à 12:16
...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `nom_complet` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `brigade` (
  `ident` int NOT NULL AUTO_INCREMENT,
  `nom_complet` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_brigade` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `numero_telephone` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_inscription` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(3, 'AGBODJAN Kossi Bruce', 'kagbodjan@otr.tg', '90611326', '2025-01-17 20:34:07', 'ea66e9c169c7e5a307eb06fb8e6a239d', NULL, NULL),
(4, 'ALOUMEDJI Emmanuel Kofi Mawoulé', 'excellencealoumedji@gmail.com', '91723907', '2025-01-17 20:53:27', 'ea66e9c169c7e5a307eb06fb8e6a239d', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `chef_brigade` (
  `ident` int NOT NULL AUTO_INCREMENT,
  `nom_complet` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_chefbrigade` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `numero_telephone` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_inscription` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reset_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `conversation_fonciere` (
  ...
  `email_conversation_fonciere` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `numero_telephone` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_inscription` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reset_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `dossier_terminer`;
CREATE TABLE IF NOT EXISTS `dossier_terminer` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `evaluation_cadastrale` (
  `ident` int NOT NULL AUTO_INCREMENT,
  `nom_complet` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_evaluation_cadastrale` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_telephone` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_inscription` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reset_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gestion_evaluation_cadastrale_terminer` (
  ...
  `date_assignation_n5` datetime DEFAULT NULL,
  `date_temine_n5` datetime DEFAULT NULL,
  `statut` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Terminé',
  `n1_admin` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `n2_chef_brigade` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_chef_brigade` int DEFAULT NULL,
  `n3_brigade` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_brigade` int DEFAULT NULL,
  `n4_securisation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_securisation` int DEFAULT NULL,
  `n5_evaluation_cadastrale` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gestion_fonciere` (
  ...
  `nom_signature` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `statut` enum('En cours','Terminé','En attente') COLLATE utf8mb4_unicode_ci DEFAULT 'En cours',
  `fonciere_id` int DEFAULT NULL,
  `validateur` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, '45688', '2025-01-04 23:00:00', '2025-01-09 18:18:11', '2025-01-11 09:24:23', '2025-01-11 09:32:28', 'En cours', 'Abalo admin', 'Abalo cb', '4', 'Abalo Brigarde', '1', 'Abalo S', '1'),
...
CREATE TABLE IF NOT EXISTS `securisation` (
  `ident` int NOT NULL AUTO_INCREMENT,
  `nom_complet` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_securisation` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `numero_telephone` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_inscription` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reset_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `signature` (
  `ident` int NOT NULL AUTO_INCREMENT,
  `nom_complet` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email_signature` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `numero_telephone` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_inscription` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reset_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `terminer_brigade` (
  ...
  `nom_brigade` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
